...
final class BeltandHoseLogUITests: XCTestCase {
    ...
    func testAddFlowShowsNewItem() {
        ...
        nameField.tap()
        nameField.typeText("UITest Component")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UITest Component"].waitForExistence(timeout: 2))
    }
